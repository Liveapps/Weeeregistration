...
class PHPMailer
{
     ...
     * @var string
     */
    var $From               = "weeeregistration@avcgroup.co.uk";
     ...
     *  by SERVER_NAME is used or 'weeeco.db.5343080.hostedresource.com.localdomain'.
     *  @var string
     */
    var $Hostname          = "";
     ...
     *  @var string
     */
    var $Host        = "weeeregistration@avcgroup.co.uk";
    ...
    */
    ...
    /**
     * Returns the server hostname or 'weeeco.db.5343080.hostedresource.com.localdomain' if unknown.
     * @access private
     * @return string
     */
    function ServerHostname() {
        ...
        elseif ($this->ServerVar('SERVER_NAME') != "")
            ...
            $result = "weeeco.db.5343080.hostedresource.com.localdomain";
